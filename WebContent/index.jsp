    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="contact.jsp"><span>IPR</span></a></li>
          
          <li class="active"><a href="contact.jsp"><span>Innopedia</span></a></li>
        </ul>
      </div>
      <div class="logo">
...
<!-- <form action="userlogin" method="post" onsubmit="return validate()">
     ...
     <tr>
     <td colspan="2"><input class="input-rounded-button" type="submit" value="LogIn" style="height: 30px;width: 80px;"/></td><td><a href="register.jsp"><img src="images/adduser.png" width="50" height="50" alt=""></img></a></td>
     </tr>
     </table>
     </center>
	 ...
	 <table align="center">
				<tr>
<!-- 				<td> -->
<!-- 				 <img src="images/people.png" width=40" height="40"><a href="userlogin.jsp"><span style="font-size:22px">User Login</span></a></td> -->
				 
<!-- 				 </tr> -->
<!-- 				 <tr> -->
<!-- 				<td> -->
<!-- 				 <br><img src="images/people.png" width=40" height="40"><a href="mentorlogin.jsp"><span style="font-size:22px">Mentor Login</span></a></td> -->
     ...
     <table align="center">
     <tr>
     <th style="color: black; font-size: 15px;">Login As: </th>
     <td><select required name="usertype" id="usertype" onChange=checkit(this.value)>
