...
<div class="main">
  <div class="header">
    <div class="header_resize">
     <div class="menu_nav">
        <ul>
          <li class="active"><a href="mentorhome.jsp"><span>Home</span></a></li>
          <li class="active"><a href="mentoridea.jsp"><span>Post Ideas</span></a></li>  
          <li class="active"><a href="userridea.jsp"><span>User Ideas</span></a></li>          
      ...
      <div class="mainbar">
        <div class="article">
         <%--  <%HttpSession session2 =request.getSession(); %>
          ...
          <h2>Post Your Ideas Here</h2><br>



	<form action="mentorideas" method="post">
	
	 <textarea rows="5" cols="50" name="idea" id="idea" placeholder="Post Your Idea Here"></textarea><br><br>
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/innohubs","root","root");  
                     //   int Userid = Integer.parseInt((String)session.getAttribute("userId"));
                       ...
                       // ResultSet rs = st.executeQuery("select * from insterrors group by errorname");
                        ...
                        ResultSet rs = st.executeQuery("select * from mentorideas");
