...
function handleChange(value){
	...
	$.ajax({
		url:'StoreRatting',
		data:{'poistid':value.id,'stars':value.value},
		method:'post',
...
<body>
	<div class="main">
        ...
        <li class="active"><a href="contact.jsp"><span>Contact Us</span></a></li>
				...
				<div class="logo">
					<h1>
						<strong style="color: white;">INNO<span>HUBS</span></strong>
					</h1>
				</div>
				<div class="searchform">
					...
					<a href="Logout" style="color: white; font-size: 25px;">Logout</a>
				...
				<div class="slider">
					<div id="coin-slider">
						<a href="#"><img src="images/s1.jpg" width="50" height="52"
							alt="" /></a> <a href="#"><img src="images/s2.jpg" width="960"
							height="360" alt="" /></a> <a href="#"><img src="images/s3.jpg"
							width="960" height="360" alt="" /></a><img src="images/s4.png"
							width="960" height="360" alt="" /><img src="images/s5.jpg"
							width="1000" height="360" alt="" />
					</div>
					<div class="clr"></div>
				</div>
				<div class="clr"></div>
          ...
          <h2>Welcome <%=session.getAttribute("username") %></h2> --%>
						...
						<div class="post_content">
							...
							<form action="ideas" method="post">
								...
								<textarea rows="5" cols="50" name="idea" id="idea"
									placeholder="Post Your Idea Hear"></textarea>
								<br>
					...
					<div class="article">
						...
						<div class="post_content">
							...
							<table border="0" cellpadding="10" cellspacing="1"
								style="width: 100%; border: 1px solid #ccc; margin-top: 40px; border-color: red;">


								<tr class="tableheader">
									<td style="color: black; font-weight: bolder;">Username</td>

									<td style="color: black; font-weight: bold;">Ideas</td>
									<td style="color: black; font-weight: bold;">Rating</td>
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/innohubs","root","root");  
                     //   int Userid = Integer.parseInt((String)session.getAttribute("userId"));
                       ...
                       // ResultSet rs = st.executeQuery("select * from insterrors group by errorname");
                        ...
                        ResultSet rs = st.executeQuery("select * from ideas");
                        while(rs.next()){
                       ...
                       String id = rs.getString("id");
                            %>
								...
								<tr class="tablerow">
									...
									<td><%= idea %></td>
									<td>
										<div id="<%= session.getAttribute("userId") %>">
										<input type="radio" name="rating<%= id %>" value="1"
										onchange="handleChange(this);" id="<%= id %>" class="star"> 
										
										<input type="radio" name="rating<%= id %>" id="<%= id %>" value="2"
										onchange="handleChange(this);" class="star"> 
										
										<input type="radio" name="rating<%= id %>" id="<%= id %>" value="3"
										onchange="handleChange(this);" class="star"> 
										
										<input type="radio" name="rating<%= id %>" id="<%= id %>" value="4"
										onchange="handleChange(this);" class="star"> 
										
										<input type="radio" name="rating<%= id %>" id="<%= id %>" value="5"
										onchange="handleChange(this);" class="star">
									</div>
									</td>
									
									<td><button name="likeordislike">LIKE</button></td>
								</tr>
								<%
