...
<h3>Assign Task To <%=request.getParameter("mentor") %></h3><br>
<form action="task" method="post">

<table>
<tr>
<td>Task1</td><td><input type="text" name="task1" id="task1" required></td>
</tr>

<tr>
<td>Task2</td><td><input type="text" name="task2" id="task2" required></td>
</tr>

<tr>
<td>Starting Date</td><td><input type="text" name="start" id="start" required></td>
<td>Ending Date</td><td><input type="text" name="end" id="end" required></td>
</tr>
