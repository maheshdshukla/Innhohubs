...
<div class="main">
  <div class="header">
    <div class="header_resize">
     ...
     <!--  <div class="menu_nav">
        <ul>
          <li class="active"><a href="home.jsp"><span>Home Page</span></a></li>
          <li><a href="interest.jsp"><span>Area Of Interest</span></a></li>
 ...
 <form action="intrestlike" method=post>
     ...
     <option value="other">OTHER</option>
        ...
        &nbsp;&nbsp;
        <input class="input-rounded-button"  type="submit" value="submit" style="height: 30px;width: 80px; position: relative; center: 389px;"></input>
        </form>
